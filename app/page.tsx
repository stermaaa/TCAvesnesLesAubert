...
import { ApparitionAuScroll } from "@/components/ApparitionAuScroll";
...
const jsonLd = {
  ...
  "@type": "SportsEvent",
  name: infosSite.nomTournoi,
  startDate: infosSite.dateDebut,
  endDate: infosSite.dateFin,
  url: infosSite.urlSite,
  location: {
    "@type": "Place",
    name: infosSite.nomClub,
    address: {
      "@type": "PostalAddress",
      addressLocality: infosSite.ville,
      postalCode: infosSite.codePostal,
      addressCountry: "FR",
    },
  },
  organizer: {
  ...
  return (
    <>
      ...
      <section className="mx-auto w-full max-w-6xl px-4 py-16 sm:px-8">
        <ApparitionAuScroll className="flex flex-col gap-6">
